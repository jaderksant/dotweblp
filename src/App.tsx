    ...
    <div className="min-h-screen bg-white text-black font-inter overflow-x-hidden selection:bg-[#0400FF] selection:text-white">
      ...
      <nav className={`fixed top-4 md:top-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-300 w-[92%] md:w-[90%] max-w-5xl rounded-full border border-gray-200/50 bg-white/70 backdrop-blur-xl py-3 px-4 md:py-4 md:px-6 shadow-[0_4px_20px_rgba(0,0,0,0.05)]`}>
        <div className="flex justify-between items-center">
          ...
          <button onClick={() => window.open(linkWhatsTeste, '_blank')} className={`px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 rounded-full font-black text-[9px] sm:text-[10px] md:text-xs uppercase tracking-widest transition-all duration-300 active:scale-95 bg-black text-white hover:bg-[#0400FF] shadow-lg`}>
            Testar Grátis
          </button>
        </div>
      </nav>
      ...
      <section className="relative pt-28 sm:pt-32 md:pt-40 px-4 md:px-6 max-w-7xl mx-auto flex flex-col items-center text-center overflow-visible">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[250px] sm:w-[300px] h-[250px] sm:h-[300px] md:w-[600px] md:h-[600px] bg-[#0400FF] blur-[150px] opacity-10 rounded-full pointer-events-none"></div>
        ...
        <div className="w-full flex justify-center relative z-10 -mt-16 sm:-mt-24 md:-mt-48 pointer-events-none perspective-container max-w-5xl mx-auto">
          <div className="animate-phone-up w-full relative flex justify-center">
            <div className="animate-float w-full relative flex justify-center flex-col items-center">
              ...
              >
                <div onClick={() => toggleFeature(101)} className="absolute top-[28%] left-[2%] lg:left-[5%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                ...
                <div onClick={() => toggleFeature(102)} className="absolute top-[24%] right-[2%] lg:right-[5%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                  <div className="flex items-center justify-between gap-3">
                ...
                <div onClick={() => toggleFeature(103)} className="absolute top-[48%] left-[-2%] lg:left-[2%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                  <div className="flex items-center justify-between gap-3">
                ...
                <div onClick={() => toggleFeature(104)} className="absolute top-[46%] right-[-2%] lg:right-[2%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                  <div className="flex items-center justify-between gap-3">
                ...
                <div onClick={() => toggleFeature(105)} className="absolute top-[68%] left-[2%] lg:left-[5%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                  <div className="flex items-center justify-between gap-3">
                ...
                <div onClick={() => toggleFeature(106)} className="absolute top-[66%] right-[2%] lg:right-[5%] pointer-events-auto cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl py-3 px-5 w-max max-w-[240px] transition-all">
                  <div className="flex items-center justify-between gap-3">
        ...
        <div className="relative z-20 text-center mt-12 sm:-mt-16 md:-mt-56 pb-12 sm:pb-16 md:pb-24 w-full pointer-events-none" style={{ opacity: scrollProgress > 0.6 ? 1 : 0, transform: `translateY(${scrollProgress > 0.6 ? 0 : '40px'})`, transition: 'all 0.6s ease-out' }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8 md:gap-6 items-stretch">
            ...
            <div className="flow-hover-card bg-[#F8F9FA] rounded-[24px] sm:rounded-[30px] md:rounded-[40px] p-6 sm:p-8 md:p-10 border border-gray-100 flex flex-col group shadow-lg">
              ...
              <div className="bg-white p-4 sm:p-5 rounded-2xl md:rounded-3xl mb-auto border border-gray-200 shadow-sm flex flex-col gap-2">
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-black">Total Mensal (até 10 func): <span className="font-black text-[#0400FF]">R$ 129,00</span></p>
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-gray-500">Plano Anual: <span className="font-black text-black">R$ 1.548,00</span></p>
            ...
            <div className="bg-[#0400FF] text-white rounded-[24px] sm:rounded-[30px] md:rounded-[40px] p-6 sm:p-8 md:p-10 transform lg:-translate-y-8 shadow-2xl shadow-blue-500/30 flex flex-col relative group transition-transform hover:-translate-y-2 lg:hover:-translate-y-10 duration-300">
              ...
              <div className="bg-black/20 p-4 sm:p-5 rounded-2xl md:rounded-3xl mb-5 sm:mb-6 md:mb-8 backdrop-blur-md border border-white/10 flex flex-col gap-2">
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-white">Total Mensal (até 20 func): <span className="font-black">R$ 189,00</span></p>
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-blue-200">Anual (2 meses off): <span className="font-black text-white">R$ 1.890,00</span></p>
            ...
            <div className="flow-hover-card bg-[#F8F9FA] rounded-[24px] sm:rounded-[30px] md:rounded-[40px] p-6 sm:p-8 md:p-10 border border-transparent flex flex-col group shadow-lg">
              ...
              <div className="bg-white p-4 sm:p-5 rounded-2xl md:rounded-3xl mb-auto border border-gray-200 shadow-sm flex flex-col gap-2">
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-black">Total Mensal (até 30 func): <span className="font-black text-[#0400FF]">R$ 219,00</span></p>
                 <p className="text-[11px] sm:text-xs md:text-sm font-bold flex justify-between text-gray-500">Anual (2 meses off): <span className="font-black text-black">R$ 2.190,00</span></p>
                 <div className="w-full h-px bg-gray-100 my-2"></div>
          ...
          {/* PLANO INFINITY */}
          <div className="premium-glow-card mt-8 sm:mt-12 md:mt-16 bg-white/80 backdrop-blur-2xl border border-white/50 text-black p-6 sm:p-8 md:p-12 rounded-[24px] sm:rounded-[30px] md:rounded-[40px] flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 shadow-xl relative overflow-hidden group">
